...
func shake(amplitude: int) -> void:
	...
	tween.interpolate_property(self, "offset", offset, new_offset, 0.2, Tween.TRANS_SINE, Tween.EASE_IN)
	tween.interpolate_property(self, "offset", offset, Vector2(0, 0), 0.2, Tween.TRANS_SINE, Tween.EASE_OUT, 0.2)
	tween.start()
